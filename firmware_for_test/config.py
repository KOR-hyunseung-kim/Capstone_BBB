...
LED_RED_PIN = 17  # GPIO17 - RGB LED red channel (PWM)
LED_GREEN_PIN = 18  # GPIO18 - RGB LED green channel (PWM)
LED_BLUE_PIN = 19  # GPIO19 - RGB LED blue channel (PWM)

# Optional: Mode Switch
MODE_SWITCH_PIN = None  # GPIO for Safety/Control mode toggle (TBD)
...
I2C_SCL_PIN = 9  # GPIO9 - I2C SCL / SCK (OLED SCK pin) (XIAO default)
...
# Longer = more accurate baseline, but takes more time
...
# Cursor Control Speed (Control Mode)
CURSOR_SPEED_FACTOR = 20  # Pixels per degree of arm tilt
